...
function cRP.taskOne()
	local finished = taskBar(2500,math.random(6,10))
	if finished then
		return true
	end
	return false
...
function cRP.taskTwo()
	local finished = taskBar(2500,math.random(6,10))
	if finished then
		local finished = taskBar(1500,math.random(6,10))
		if finished then
			return true
		end
	end
...
function cRP.taskThree()
	...
	if finished then
		local finished = taskBar(1500,math.random(6,10))
		if finished then
			local finished = taskBar(750,math.random(6,10))
			if finished then
				return true
			end
		end
...
function cRP.taskLockpick()
	local finished = taskBar(2100,math.random(6,9))
	if finished then
		local finished = taskBar(1400,math.random(6,9))
		if finished then
			local finished = taskBar(700,math.random(6,9))
			if finished then
				return true
			end
		end
...
function taskThree()
	local finished = taskBar(2500,math.random(6,10))
	if finished then
		local finished = taskBar(1500,math.random(6,9))
		if finished then
			local finished = taskBar(750,math.random(6,8))
			if finished then
				return true
			end
		end
...
-----------------------------------------------------------------------------------------------------------------------------------------
function taskHomes()
	local finished = taskBar(4000,math.random(6,10))
	if finished then
		local finished = taskBar(3000,math.random(6,9))
		if finished then
			local finished = taskBar(2000,math.random(6,8))
			if finished then
				return true
			end
		end
...
RegisterCommand('arrumar2', function()
    local finished = taskBar(3000,math.random(6,10))
	if finished then
		local finished = taskBar(2000,math.random(6,9))
		if finished then
			local finished = taskBar(1000,math.random(6,8))
			if finished then
