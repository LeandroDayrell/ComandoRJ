...
local valores = {
	...
	{ item = "c4", quantidade = 1, compra = 800, venda = 300 },
	...
	--
	{ item = "ak103pack", quantidade = 1, compra = 148500, venda = 10000 },
	---
	{ item = "municaomusketpack", quantidade = 1, compra = 29700, venda = 10000 },
	{ item = "municaoparafalpack", quantidade = 1, compra = 29700, venda = 10000 },
	
	{ item = "musketpack", quantidade = 1, compra = 297000, venda = 10000 },
	{ item = "parafalpack", quantidade = 1, compra = 297000, venda = 10000 },
	---
	{ item = "mtarpack", quantidade = 1, compra = 76680, venda = 10000 },
	{ item = "sigpack", quantidade = 1, compra = 76680, venda = 10000 },
	{ item = "pumpshotgunpack", quantidade = 1, compra = 78300, venda = 10000 },
	{ item = "uzipack", quantidade = 1, compra = 76680, venda = 10000 },
	{ item = "fivesevenpack", quantidade = 1, compra = 41000, venda = 10000 },
	{ item = "coletepack", quantidade = 1, compra = 13000, venda = 10000 },
	{ item = "snspack", quantidade = 1, compra = 30400, venda = 1000 },
	{ item = "municaofamaspack", quantidade = 1, compra = 6500, venda = 1000 },
	{ item = "municaosigpack", quantidade = 1, compra = 7668, venda = 1000 },
	{ item = "municaopumppack", quantidade = 1, compra = 7668, venda = 1000 },
	{ item = "municaoakpack", quantidade = 1, compra = 24300, venda = 1000 },
	{ item = "municaouzipack", quantidade = 1, compra = 7668, venda = 1000 },
	{ item = "municaopistolpack", quantidade = 1, compra = 4100, venda = 1000 },
	{ item = "municaosnspack", quantidade = 1, compra = 3400, venda = 1000 },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- COMPRAR
-----------------------------------------------------------------------------------------------------------------------------------------
