...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	elseif data == "utilidades-comprar-radinho" then
		TriggerServerEvent("armamentos-comprar","walkietalkie")	
	...
	elseif data == "utilidades-vender-paraquedas" then
		...
		elseif data == "utilidades-vender-radinho" then
		TriggerServerEvent("armamentos-vender","walkietalkie")
