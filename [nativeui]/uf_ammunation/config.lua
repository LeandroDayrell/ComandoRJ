...
config.items = {
	["armas de fogo"] = {
		{ item = "wbody|WEAPON_MUSKET", quantidade = 1, compra = 80000 , descricao = "Rifle Winchester é um termo abrangente que descreve uma série de rifles de repetição por ação de alavanca, fabricados pela Winchester Repeating Arms Company", img = "musket" },
	},
	["armas brancas"] = {
		...
		{ item = "wbody|WEAPON_BAT", quantidade = 1, compra = 2000, descricao = "Taco de beisebol de alumínio com alça de couro. Leve, mas poderoso, para todos os grandes rebatedores.", img = "bat" },
		...
		{ item = "wbody|WEAPON_BATTLEAXE", quantidade = 1, compra = 2000, descricao = "Se é bom o suficiente para soldados medievais, guardas de fronteira modernos e mães agressivas do futebol, é bom o suficiente para você.", img = "battleaxe" },
	...
	["utilitarios"] = {
		...
		{ item = "colete1", quantidade = 1, compra = 20000, descricao = "Colete leve, preenche 25% da barra.", img = "colete" },
		{ item = "wammo|WEAPON_MUSKET", quantidade = 20, compra = 3000 , descricao = "Caixa com 20 Munições", img = "ammo_musket" },
