...
-----------------------------------------------------------------------------------------------------------------------------------------
local valores = {
	{ item = "dourado", venda = 440 },
	{ item = "corvina", venda = 310 },
	{ item = "salmao", venda = 350 },
	{ item = "pacu", venda = 300 },
	{ item = "pintado", venda = 300 },
	{ item = "pirarucu", venda = 350 },
	{ item = "tilapia", venda = 300 },
	{ item = "tucunare", venda = 350 },
