...
Config.RealWeapons = {
	...
	{ name = 'WEAPON_COMBATMG',bone=24818,x=0.12,y=-0.15,z=0.04,xRot=0.0,yRot=135.0,zRot=0.5,model='w_mg_combatmg' },
	{ name = 'WEAPON_SNIPERRIFLE',bone=24818,x=0.08,y=-0.15,z=0.08,xRot=0.0,yRot=135.0,zRot=0.0,model='w_sr_sniperrifle' },
