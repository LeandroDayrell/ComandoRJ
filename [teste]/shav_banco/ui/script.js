...
month[11] = "DEZEMBRO";
    ...
    function myTimer() {
        ...
        document.getElementById("hour").innerHTML = `${(month[d.getMonth()])} | <span>${d.getHours()}:${d.getMinutes()}</span>`;
        }
    }
    ...
    $('#saque').mouseover(()=>{
        $('#saque img').attr('src','https://i.imgur.com/0cFGNeO.png');
    });
    $('#deposito').click(()=>{
        $("#valor").val(""); $("#id").val("")
    ...
    $('#deposito').mouseover(()=>{
        $('#deposito img').attr('src','https://i.imgur.com/NY6b7SC.png');
    });
    $('#transferencia').click(()=>{
    ...
    $('#transferencia').mouseover(()=>{
        $('#transferencia img').attr('src','https://i.imgur.com/LPRd6Io.png');
    });
    ...
    $('#multas').mouseover(()=>{
        $('#multas img').attr('src','https://i.imgur.com/cj5CKZS.png');
    });
    ...
    document.onkeyup = function(data) {
        if (data.which == 27) {
          $.post("http://shav_banco/close", JSON.stringify({}), function(datab) {});
        }
      };
});