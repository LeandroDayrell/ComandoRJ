 ...
 * wantedLevel is an integer value representing 0 to 5 stars even though the game supports the 6th wanted level but no Policia will appear since no definitions are present for it in the game files
