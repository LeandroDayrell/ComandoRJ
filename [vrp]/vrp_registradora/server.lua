					...
					for l,w in pairs(policia) do
						...
						if player then
							async(function()
								...
								TriggerClientEvent('chatMessage',player,"911",{65,130,255},"O"O ID: "..user_id.." iniciou roubo na ^1Caixa Registradora^0, dirija-se até o local e intercepte o assaltante.")
