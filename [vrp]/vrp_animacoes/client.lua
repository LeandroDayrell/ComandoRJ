...
local animacoes = {
	...
	{ nome = "dancar254" , dict = "anim@amb@nightclub@lazlow@hi_dancefloor@" , anim = "dancecrowd_li_11_hu_shimmy_laz", prop = "ba_prop_battle_hobby_horse", hand = 28422 , andar = false , loop = false },
	{ nome = "dancar255" , dict = "anim@amb@nightclub@lazlow@hi_dancefloor@" , anim = "crowddance_hi_11_handup_laz", prop = "ba_prop_battle_hobby_horse", hand = 28422 , andar = false , loop = false },
	{ nome = "dancar256" , dict = "anim@amb@nightclub@lazlow@hi_dancefloor@" , anim = "dancecrowd_li_15_handup_laz", prop = "ba_prop_battle_hobby_horse", hand = 28422 , andar = false , loop = false },
	{ nome = "dancar257" , dict = "anim@amb@casino@mini@dance@dance_solo@female@var_b@" , anim = "high_center" , andar = false , loop = true },
	{ nome = "dancar258" , dict = "anim@mp_player_intcelebrationfemale@the_woogie" , anim = "the_woogie" , andar = false , loop = true },
	{ nome = "dancar259" , dict = "anim@amb@nightclub@mini@dance@dance_solo@female@var_a@" , anim = "med_center_up" , andar = false , loop = true },
	{ nome = "dancar260" , dict = "timetable@tracy@ig_8@idle_b" , anim = "idle_d" , andar = false , loop = true },
	{ nome = "dancar261" , dict = "timetable@tracy@ig_5@idle_a" , anim = "idle_a" , andar = false , loop = true },
	{ nome = "dancar262" , dict = "anim@amb@nightclub@lazlow@hi_podium@" , anim = "danceidle_hi_11_buttwiggle_b_laz" , andar = false , loop = true },
	{ nome = "dancar263" , dict = "move_clown@p_m_two_idles@" , anim = "fidget_short_dance" , andar = false , loop = true },
	...
	{ nome = "patodonald" , dict = "anim@safehouse@bong" , anim = "bong_stage1" , prop = "prop_bong_01" , flag = 50 , hand = 60309 , extra = function() 
		if not IsPedInAnyVehicle(PlayerPedId()) then
			TriggerEvent('cancelando',true)
			TriggerEvent("progress",9000,"fumando")
			TriggerEvent("vrp_sound:source",'bong',0.5)
...
AddEventHandler("onResourceStart", function(resource)
    if resource == GetCurrentResourceName() then
        print("\n^1VRP_ANIMACOES- ^2EDITADO POR ^1CURIOUS\n^0")
    end
end)
